...
def pacientes(request):
    ...
    if pacientes.exists():
        messages.add_message(request, constants.ERROR, 'Ja existe um paciente com esse e-mail')
        return redirect('/pacientes/')
    ...
    try:
        ...
        p1.save()
        messages.add_message(request, constants.SUCCESS, 'Ja existe um paciente com esse e-mail')
        return redirect('/pacientes/')
